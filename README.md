...
Requires an API-Key from Telegram named "TELEGRAM_API_KEY" for the bot and an <https://www.weatherapi.com/> API-Key named "WEATHER_API_KEY" as environmental variables.<br/>
